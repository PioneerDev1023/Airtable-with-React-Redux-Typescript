...
//const base = new Airtable({apiKey: process.env.REACT_APP_API_KEY}).base('process.env.BASE_ID');

var base = new Airtable({ apiKey: 'keyIBCm53HDHia3tA' }).base('app8ZbcPx7dkpOnP0');

const table = base('Classes');
